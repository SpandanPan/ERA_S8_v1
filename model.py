...
class Model_Norm(nn.Module):
  """ 
  This model file will be used for BN/GN/LN assignment
  ...
  """
    def __init__(self,norm_type):
        ...
        # Conv Layer 1
        self.conv1 = nn.Conv2d(in_channels=3, out_channels=10, kernel_size=(3, 3), padding=1, bias=False)
        if norm_type=='bn':
       ...
       # Conv Layer 2
        self.conv2 = nn.Conv2d(in_channels=10, out_channels=10, kernel_size=(3, 3), padding=1, bias=False)
        if norm_type=='bn':
       ...
       # TB Conv Layer1 1*1
        self.conv_tb1 = nn.Conv2d(in_channels=10, out_channels=10, kernel_size=(1, 1), padding=0, bias=False)
       # Max Pool Layer 1
        self.pool1 = nn.MaxPool2d(kernel_size=2,stride=2)

      # Conv Layer 3
        self.conv3 = nn.Conv2d(in_channels=10, out_channels=10, kernel_size=(3, 3), padding=0, bias=False)
        if norm_type=='bn':
      ...
      # Conv Layer 4
       ...
       # Conv Layer 5
        self.conv5 = nn.Conv2d(in_channels=10, out_channels=10, kernel_size=(3, 3), padding=1, bias=False)
        if norm_type=='bn':
      ...
      # TB Conv Layer2 1*1
        self.conv_tb2 = nn.Conv2d(in_channels=10, out_channels=10, kernel_size=(1, 1), padding=0, bias=False)
       # Max Pool Layer 2
        self.pool2 = nn.MaxPool2d(kernel_size=2,stride=2)

       # Conv Layer 6
        self.conv6 = nn.Conv2d(in_channels=10, out_channels=10, kernel_size=(3, 3), padding=1, bias=False)
        if norm_type=='bn':
          self.norm6=nn.BatchNorm2d(10)
        elif norm_type=='ln':
      ...
      # Conv Layer 7
        self.conv7 = nn.Conv2d(in_channels=10, out_channels=10, kernel_size=(3, 3), padding=1, bias=False)
        if norm_type=='bn':
          self.norm7=nn.BatchNorm2d(10)
        elif norm_type=='ln':
       ...
       # Conv Layer 8
        self.conv8 = nn.Conv2d(in_channels=10, out_channels=10, kernel_size=(3, 3), padding=0, bias=False)
        if norm_type=='bn':
          self.norm8=nn.BatchNorm2d(10)
        elif norm_type=='ln':
       ...
       # Output Layer
        self.conv9 = nn.Conv2d(in_channels=10, out_channels=10, kernel_size=(1, 1), padding=0, bias=False)


    def forward(self, x):
        x = self.dp1(self.norm1(F.relu(self.conv1(x))))
        x = self.dp2(self.norm2(F.relu(self.conv2(x))))
        x=  self.pool1(self.conv_tb1(x))
        x = self.dp3(self.norm3(F.relu(self.conv3(x))))
        x = self.dp4(self.norm4(F.relu(self.conv4(x))))
        x = self.dp5(self.norm5(F.relu(self.conv5(x))))
        x=  self.pool2(self.conv_tb2(x))
        x = self.dp6(self.norm6(F.relu(self.conv6(x))))
        x = self.dp7(self.norm7(F.relu(self.conv7(x))))
        x = self.dp8(self.norm8(F.relu(self.conv8(x))))
        x = self.gap(x)
        x = self.conv9(x)
        x = x.view(-1, 10)
